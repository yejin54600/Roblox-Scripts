-- Optimized Model Manager (Auto-Search on Select)
...
MainFrame.Name = "AutoSearchExplorer"
...
Title.Text = "  Model & Script Manager (Auto-Search)"
...
local function giveSelectionTool()
    ...
    Tool.Activated:Connect(function()
        ...
        -- NEW FEATURE: Auto-type name into search box and update list immediately
        SearchBox.Text = finalTarget.Name
        
        Tool.Name = "Added & Searched!"
        task.wait(0.5)
        Tool.Name = "Selection Tool"
    end)
